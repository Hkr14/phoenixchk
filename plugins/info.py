...
async def info(Client, message):
 ...
 User Name: <b>{message.from_user.username}</b>
 User Id: <b><code>{message.from_user.id}</code></b>
 Limited: <b>{message.from_user.is_restricted}</b>
 Profile Link: <b><a href="tg://user?id={message.from_user.id}">Click Here</a></b>
 ...
 Chat Information:-
 Chat Name: <b>{message.chat.title}</b>
 User Name: <b>{message.chat.username}</b>
 Chat Id: <b><code>{message.chat.id}</code></b>
 Chat Type: <b>{message.chat.type.capitalize()}</b>
    """
